#[
  https://github.com/tdely/nim-rwlocks/blob/master/rwlocks.nim
  Ships directly for convenience.
  Using atomics for readers count could:
    - improve speed of 15% for acquireRead/releaseRead
    - decrease speed of 15% for acquireWrite/releaseWrite
    - will add a lot more complexity
  So for now, keep with the original
]#
